...
- **UI Parity In Progress** – Rebuilding these menus to match the 2D game exactly—including fonts, colours, button visibility rules and backgrounds—is an ongoing effort. Continue updating them until they are indistinguishable from the original.
